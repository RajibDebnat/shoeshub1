import { airJordanData } from '../../Constant';
  ...
  return (
    <main>
      <section className=" max-md:p-2 pb-10  px-60 max-lg:px-10 max-sm:flex max-sm:flex-col max-sm:justify-center ">
        ...
        <div className=" max-sm:justify-center flex flex-wrap gap-6 max-md:gap-4   max-sm:grid max-sm:grid-cols-2 ">
     {airJordanData.map(data=>{
